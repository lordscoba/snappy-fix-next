...
// import { createContactMessage } from "@/services/contact-service"; // Adjust path as needed
import { ContactCategory, ContactPayload } from "@/types/contact-types";
import { createContactMessage } from "@/lib/api/services/contact-us.services";
...
// ─── Enquiry types (Updated with Enum) ────────────────────────────────────────
const ENQUIRY_TYPES = [
  {
    icon: Code2,
    label: "Website Development",
    value: ContactCategory.WEBSITE_DEVELOPMENT,
  },
  {
    icon: ImageIcon,
    label: "Online Tools Feedback",
    value: ContactCategory.ONLINE_TOOLS_FEEDBACK,
  },
  {
    icon: MessageCircle,
    label: "General Enquiry",
    value: ContactCategory.GENERAL_ENQUIRY,
  },
  {
    icon: Mail,
    label: "Partnership",
...
export default function ContactMainContent() {
  ...
  const [enquiryType, setEnquiryType] = useState<ContactCategory>(
    ContactCategory.GENERAL_ENQUIRY,
  );
    ...
    <section id="contact" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-10">
          ...
          {/* ── Right: Contact form ── */}
          <div className="bg-white border border-[#e9e1ff] rounded-3xl p-7 md:p-10 shadow-sm transition-all duration-300">
            {sent ? (
              /* ── Success state ── */
              <div className="flex flex-col items-center justify-center text-center py-16 space-y-5 animate-in fade-in zoom-in duration-300">
              ...
              <>
                ...
                >
                  ...
                  <FormField
                    ...
                    placeholder={
                      enquiryType === ContactCategory.WEBSITE_DEVELOPMENT
                        ? "New Website Project"
                        : "General Inquiry"
                    }
                    required
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full border border-[#e9e1ff] rounded-2xl px-5 py-3.5 resize-none focus:outline-none focus:ring-2 focus:ring-[#5b32b4]/30 focus:border-[#5b32b4]/40 text-[#2b1d3a] text-sm placeholder-gray-300 transition-all disabled:bg-gray-50 disabled:cursor-not-allowed"
                    />
                  </div>
  ...
  return (
    <div className="space-y-1.5">
      ...
      <input
        ...
        className="w-full border border-[#e9e1ff] rounded-2xl px-5 py-3.5 focus:outline-none focus:ring-2 focus:ring-[#5b32b4]/30 focus:border-[#5b32b4]/40 text-[#2b1d3a] text-sm placeholder-gray-300 transition-all disabled:bg-gray-50 disabled:cursor-not-allowed"
      />
    </div>
  );
}
