...
//       if (!completedCrop) {
//         setError("Please adjust crop area.");
//         return;
//       }

//       const { x, y, width, height } = completedCrop;

//       const responsePromise = cropImage(
//         file,
//         {
//           left: Math.round(x),
//           top: Math.round(y),
...
//                 Drop your image for cropping
//               </p>
//               <p className="text-sm text-gray-400 mt-1">
//                 or click to select your image for cropping
//               </p>
//             </div>
//           </div>
//         ) : (
//           <div className="space-y-4">
//             <div className="relative max-h-[500px] overflow-auto rounded-2xl bg-gray-100 p-4">
//               <ReactCrop
//                 crop={crop}
//                 onChange={(c) => setCrop(c)}
//                 onComplete={(c) => setCompletedCrop(c)}
